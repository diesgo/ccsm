        ...
        <body class="w3-theme-light font-<?php echo $settings['fuente'] ?>">
            ...
            <div class="w3-container w3-top w3-theme-dark w3-large" style="z-index:4; padding: 8px 8px">
                <div class="w3-bar w3-padding">
                    ...
                    <a class="w3-bar-item w3-button w3-border w3-border-theme w3-round w3-theme-d3 w3-hover-white w3-hover-text-theme w3-right" href="../../dispensario/home/index.php">Dispensario</a>
                </div>
            </div>
