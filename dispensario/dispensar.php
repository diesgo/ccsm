...
<body class="w3-theme-light font-varela">
    ...
    <nav class="w3-sidebar w3-collapse w3-theme-l4" style="z-index:3; width: 25%" id="mySidebar"><br>
        ...
        <div class="w3-container">
            ...
            <div class="w3-half w3-padding-tiny">
                <h6>Nº Socio: <span id="numberSocio"><?php echo $socios['id'] ?> &#128286;</span></h6>
    ...
    <div class="w3-container" style="margin-left: 25%; padding: 0px">
        ...
        <div id="tab01" class="tabcontent">
            <div class="w3-container" style="position:relative;z-index: -1000;">
                <div class="w3-threequarter">

                    <div class="w3-container w3-content w3-center w3-round w3-green">
                        <h1>DISPENSAR</h1>
                    </div>

                    <div class="w3-container">
                        <div id="items" class="w3-row"></div>
                    </div>
                </div>

                <div class="w3-quarter w3-border w3-border-green w3-round w3-padding" style="width:25%;right:16px;">
                    <span id="numeroSocio"></span>
                    <img src="#" alt="Foto Socio" id="fotoSocio" class="w3-image">
                    <p>Nombre: <span id="nameSocio"></span></p>
                    <p>Edad: <span id="nameSocio"></span></p>
                    <p>Saldo disponible: <span id="saldoSocio"></span></p>
                    ...
                    <div class="w3-container">
                        <div class="w3-content">
                            <table class="w3-table">
                                <tr>
                                    <td class="w3-center">
                                        <input type="Button" id="7" value="7" onclick="mostra('7');" style="padding: 8px 16px;" />
                                    </td>
                                    <td class="w3-center">
                                        <input type="Button" id="8" value="8" onclick="mostra('8');" />
                                    </td>
                                    <td class="w3-center">
                                        <input type="Button" id="9" value="9" onclick="mostra('9');" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="w3-center">
                                        <input type="Button" id="4" value="4" onclick="mostra('4')" />
                                    </td>
                                    <td class="w3-center">
                                        <input type="Button" id="5" value="5" onclick="mostra('5');" />
                                    </td>
                                    <td class="w3-center">
                                        <input type="Button" id="6" value="6" onclick="mostra('6');" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="w3-center">
                                        <input type="Button" id="1" value="1" onclick="mostra('1');" />
                                    </td>
                                    <td class="w3-center">
                                        <input type="Button" id="2" value="2" onclick="mostra('2');" />
                                    </td>
                                    <td class="w3-center">
                                        <input type="Button" id="3" value="3" onclick="mostra('3');" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="w3-center">
                                        <input type="Button" id="0" value="0" onclick="mostra('0');" />
                                    </td>
                                    <td class="w3-center">
                                        <input type="Button" id="," value="," onclick="mostra('.')" />
                                    </td>
                                    <td class="w3-center">
                                        <input type="Button" id="C" value="C" onclick="teclaC();" />
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <div id="tab02" class="tabcontent">
            ...
            <div id="tab101" class="tabcontent w3-row-padding">
                ...
                <div class="producto w3-col l3 w3-margin-bottom w3-padding-small" data-idproducto="Coca-cola" data-img="img/p/f01.jpg" data-precio="1" data-cantidad="0">
                ...
                <div class="producto w3-col l3 w3-margin-bottom w3-padding-small" data-idproducto="Fanta de naranja" data-img="img/p/f02.jpg" data-precio="1" data-cantidad="0">
                    <div class="w3-container w3-round w3-border" style="padding: 0px; height: 160px;">
                        <div class="w3-half w3-padding-small">
                ...
                <div class="producto w3-col l3 w3-margin-bottom w3-padding-small" data-idproducto="Dr Pepper" data-img="img/p/f03.jpg" data-precio="1" data-cantidad="0">
                    <div class="w3-container w3-round w3-border" style="padding: 0px; height: 160px;">
                        <div class="w3-half w3-padding-small">
                ...
                <div class="producto w3-col l3 w3-margin-bottom w3-padding-small" data-idproducto="Agua" data-img="img/p/f04.jpg" data-precio="1" data-cantidad="0">
                    <div class="w3-container w3-round w3-border" style="padding: 0px; height: 160px;">
                        <div class="w3-half w3-padding-small">
