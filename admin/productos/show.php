            ...
            <div class="w3-container w3-padding-32 w3-theme-l4">
                <div class="w3-half">
                    <h2 class="w3-text-theme"><b><?php echo $productos['nombre_producto']; ?></b></h2>
                </div>
                <div class="w3-half">
                </div>
            </div>
                ...
                <div class="w3-content">
                    <div class="w3-row-padding">
                        <div class="w3-col l3 m3">
                            <h4 class="w3-text-theme">Categoría: <span class="w3-text-dark-grey"><?php echo $productos['nombre_categoria']; ?></span></h4>                            
                        </div>
                        <div class="w3-col l3 m3">
                            <h4 class="w3-text-theme">Variedad: <span class="w3-text-dark-grey"><?php echo $productos['nombre_variedad']; ?></span></h4>                            
                        </div>
                        <div class="w3-col l3 m3">
                    ...
                    <div class="w3-half w3-margin-top w3-padding w3-border w3-border-theme w3-round">
                        <div class="w3-row-padding">
                            ...
                            <div class="w3-col l8">
                                <p class="w3-text-theme w3-xlarge">Artículo # <span id="id"><?php echo $productos['id_producto']; ?></span></p>
                                <p class="w3-text-theme w3-large">Nombre: <span class="w3-text-grey" id="nombre"><?php echo $productos['nombre_producto']; ?></span></p>
                                <p class="w3-text-theme w3-large">Categoría: <span class="w3-text-grey" id="categoria"><?php echo $productos['nombre_categoria']; ?></span></p>
                                <p class="w3-text-theme w3-large">Variedad: <span class="w3-text-grey" id="variedad"><?php echo $productos['nombre_variedad']; ?></span></p>
