...
<div class="w3-container w3-padding-32 w3-theme-l4">
    ...
    <div class="w3-half">
        ...
        if (isset($_POST['actualizar'])) {
            ...
            $pvc = $_POST['pvc'];
            $pvp = $_POST['pvp'];
            $sql = "UPDATE productos SET nombre ='" . $nombre . "', categoria ='" . $categoria . "', variedad ='" . $variedad . "', servicio ='" . $servicio . "', bote ='" . $bote . "', cantidad ='" . $cantidad . "', pvc ='" . $pvc . "', pvp ='" . $pvp . "' WHERE id=" . $id . ";";
                ...
                <div class="w3-row-padding">
                    ...
                    <div class="w3-col l3 m3 w3-padding">
                        <div class="w3-container w3-padding w3-border w3-border-theme w3-round">
                            ...
                            <input id="pvc" class="w3-input w3-border w3-border-theme w3-round w3-margin-bottom" type="text" name="pvc" value="" placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div class="w3-col l3 m3 w3-padding">
                        <div class="w3-container w3-padding w3-border w3-border-theme w3-round">
                            ...
                            <input id="cantidad" class="w3-input w3-border w3-border-theme w3-round w3-margin-bottom" type="text" name="cantidad" value="" onkeyup="cargar();">
                        </div>
                    </div>
