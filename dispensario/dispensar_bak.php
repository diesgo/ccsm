    ...
    <div class="w3-container">
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<div class='w3-col l2 m2'>";
                    echo "<div class='w3-padding'>";
                    echo "<img class='w3-image' src='../img/p/0.jpg'>";
                    echo "<h5 class='card-title'>" . $row['nombre'] . "</h5>";
                    echo "<p class='card-text'>" . $row['pvp'] . "</p>";
                    echo "<button class='w3-button w3-theme' marcador='" . $row['id'] . "'>+</button>";
                    echo "</div></div>";
                }
            } else {
                echo "0 results";
