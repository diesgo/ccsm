 ...
 <body class="w3-theme-light font-<?php echo $settings['fuente'] ?>">
     ...
     <nav class="w3-sidebar w3-collapse w3-theme-d3 panel" style="z-index:3;margin-left:75%;width:25%;" id="mySidebar"><br>
         ...
         <div class="w3-bar-block">
             ...
             <button class="w3-button w3-block w3-left-align w3-theme-l1 w3-hover-theme" onclick="dropAside('catalogo')"><i class="fas fa-boxes"></i> Categorías <i class="w3-right fa fa-caret-down"></i></button>
