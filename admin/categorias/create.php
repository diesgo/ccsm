                ...
                <div class="w3-content">
                    <form accept-charset="utf-8" action="#" method="post" name="altaCategoria" id="altaCategoria" class="w3-theme-l4 w3-round w3-padding">

                        <!--  NOMBRE -->

                        <div class="w3-row">
                            <div class="w3-col m6 l6 s12 w3-padding w3-margin-bottom">
                                <label for='nombrea' class="w3-text-theme w3-medium">Categoria</label>
                        ...
                        <div class="w3-row">
                            <div class="w3-col m12 l12 s12 w3-padding w3-margin-top w3-margin-bottom">
                                <legend for="descripcion" class="w3-text-theme w3-medium">Descripción</legend>
                                <textarea class="w3-block w3-border w3-border-theme-light" name="descripcion" id="descripcion" rows="5" placeholder="(Opcional)"></textarea>
