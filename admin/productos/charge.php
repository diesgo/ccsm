                                        ...
                                        <div class="w3-row">
                                            ...
                                            <div class="w3-col w3-padding">
                                                <div class="w3-container w3-padding w3-border w3-border-theme w3-round-xlarge">
                                                    ...
                                                    <input id="recarga" class="w3-input w3-border w3-border-theme-l4 w3-round w3-margin-bottom" type="text" placeholder="gr." name="recarga" value="" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="w3-col w3-padding">
                                                <div class="w3-container w3-padding w3-border w3-border-theme w3-round-xlarge">
                                                    ...
                                                    <input type="text" name="pc" id="pc" class="w3-input w3-border w3-border-theme-l4 w3-round w3-margin-bottom" placeholder="€" value="" required>
                                                </div>
                                            </div>
