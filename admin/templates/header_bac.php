...
<head>
    ...
    <link rel="stylesheet" href="/club/css/w3-theme-green-grey.css">
...
<body class="w3-theme-light">
    ...
    <nav class="w3-sidebar w3-collapse w3-theme-d3 panel" style="z-index:3;width:300px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="/club/admin/index.php" class="w3-bar-item w3-button w3-padding w3-theme-l1 w3-hover-theme"> <i class="fas fa-tachometer-alt"></i> Home</a>
